...
- Object inheritance could be improved and native Laravel classes and objects could be utilised more. In particular the response interfaces need cleaning up. Limited time did not allow for this.
